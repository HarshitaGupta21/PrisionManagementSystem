<%-- 
    Document   : viewc
    Created on : Jun 22, 2017, 7:57:19 PM
    Author     : DLK 1
--%>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
             ...
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&emsp;Cell No</strong></b></td>
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&nbsp;&nbsp;Description</strong>&emsp;</b></td>
                                </tr>
         <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
...
<% 
                        ...
                        String Query22="select * from addc ";
                        ...
                        %>
                                <tr>  
                                    ...
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;&nbsp;&nbsp;<%=rs22.getString("cno")%></td>
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;<%=rs22.getString("des")%>&emsp;</td>
                                <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
  </tr>
