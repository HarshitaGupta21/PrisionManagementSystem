<%-- 
    Document   : adde
    Created on : Jun 22, 2017, 7:37:32 PM
    Author     : DLK 1
--%>
...
<div id="wh_bg">
    ...
    <div id="top">
      <div class="top1" style="width: 1000px;"></div>
       <div id="menu">
        ...
        <br>
        <form  method="post" action="ereg.jsp" style="margin-left: 314px;" >     
 ...
 while(rs2.next()){
     ...
     %>
        ...
        <br><br/>          
        <strong>Course ID :</strong>&emsp;&emsp;&emsp; <input type="text"  required=""  name="cid" style="width: 200px;" >&emsp;&emsp;<br><br/> 
        <strong>Course Name:</strong>&emsp;&emsp;<input type="text" name="cname" value="" required="" style="width: 200px;" /><br><br>
        <strong>Duration:</strong>&emsp;&emsp;&emsp;&emsp;<input type="text" name="dur" value="" required="" style="width: 200px;" /><br><br></br>
