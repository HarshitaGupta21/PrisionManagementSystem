<%-- 
    Document   : transfer
    Created on : Jun 22, 2017, 3:24:34 PM
    Author     : DLK 1
--%>
...
<div id="wh_bg">
  <div id="bg_bg">
    ...
    <div id="content" style="margin-left: 86px;"> 
        <br><br><br>
        <a href="addtr.jsp"><h1>Add Prisoner for transfer</h1></a>
        <a href="viewtr.jsp"><h1>View Transfer Details</h1></a>        
      <img src="images/tra.jpg" width="440" height="279" alt="" class="flt" style="margin-left: 374px;margin-top: -182px;" />
    </div>
     </div>
