<%-- 
    Document   : case
    Created on : Jun 22, 2017, 3:25:04 PM
    Author     : DLK 1
--%>
...
<div id="wh_bg">
  <div id="bg_bg">
    ...
    <div id="content" style="margin-left: 126px;"> 
        <br><br><br>
        <a href="addc.jsp"><h1>Add Case</h1></a>
        <a href="viewc.jsp"><h1>View Case</h1></a>        
      <img src="images/Jail_Desk.JPG" width="440" height="279" alt="" class="flt" style="margin-left: 314px;margin-top: -182px;" />
    </div>
     </div>
