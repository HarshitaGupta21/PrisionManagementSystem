<%-- 
    Document   : remand
    Created on : Jun 22, 2017, 3:24:43 PM
    Author     : DLK 1
--%>
...
<div id="wh_bg">
  <div id="bg_bg">
    ...
    <div id="content" style="margin-left: 126px;"> 
        <br><br><br>
        <a href="addr.jsp"><h1>Add Remand Case</h1></a>
        <a href="viewr.jsp"><h1>View Remand Case</h1></a>        
      <img src="images/prisoner.png" width="440" height="279" alt="" class="flt" style="margin-left: 314px;margin-top: -182px;" />
    </div>
     </div>
