<%-- 
    Document   : viewe
    Created on : Jun 22, 2017, 7:37:38 PM
    Author     : DLK 1
--%>
...
<div id="wh_bg">
  <div id="bg_bg">
    ...
    <div id="content"> 
       <center>
                                                <h2 >View Education Details</h2><br>
                                                                   <%
        try{        
    %>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
             ...
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;Course Id</strong></b></td>
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;Course Name</strong></b></td>
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;Durtion</strong></b></td>
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&emsp;Starting Date</strong></b></td>
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&emsp;In Time</strong></b></td>
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&emsp;Out Time&emsp;</strong></b></td>
                                </tr>
         <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
...
<% 
                        ...
                        String Query22="select * from adde ";
                        ...
                        %>
                                <tr>  
                                    ...
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;<%=rs22.getString("cid")%></td>
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;<%=rs22.getString("cname")%></td>
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&nbsp;<%=rs22.getString("dur")%></td>
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;&emsp;<%=rs22.getString("sdate")%></td>
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;<%=rs22.getString("itime")%></td>
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;<%=rs22.getString("otime")%>&emsp;</td>
                                <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
  </tr>
