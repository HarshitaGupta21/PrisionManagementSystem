<%-- 
    Document   : education
    Created on : Jun 22, 2017, 3:24:54 PM
    Author     : DLK 1
--%>
...
<div id="wh_bg">
  <div id="bg_bg">
    ...
    <div id="content" style="margin-left: 126px;"> 
        <br><br><br>
        <a href="adde.jsp"><h1>Add Education Details</h1></a>
        <a href="viewe.jsp"><h1>View Education Details</h1></a>        
      <img src="images/train.jpg" width="440" height="279" alt="" class="flt" style="margin-left: 334px;margin-top: -182px;" />
    </div>
     </div>
