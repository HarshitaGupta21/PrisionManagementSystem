<%-- 
    Document   : viewtr
    Created on : Jun 22, 2017, 6:40:59 PM
    Author     : DLK 1
--%>
...
<div id="wh_bg">
  <div id="bg_bg">
    ...
    <div id="content"> 
       <center>
                                                <h2 >View Transfer Details</h2><br>
                                                                   <%
        try{        
    %>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
             ...
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&emsp;From</strong></b></td>
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&emsp;To</strong></b></td>
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&emsp;Reason&emsp;</strong></b></td>
                                </tr>
         <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
...
<% 
                        ...
                        String Query22="select * from addtrans ";
                        ...
                        %>
                                <tr>  
                                    ...
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&nbsp;<%=rs22.getString("type")%></td>
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&nbsp;<%=rs22.getString("fro")%></td>
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&nbsp;<%=rs22.getString("too")%></td>
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&nbsp;<%=rs22.getString("rea")%>&emsp;</td>
                                <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
  </tr>
