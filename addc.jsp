<%-- 
    Document   : addc
    Created on : Jun 22, 2017, 7:57:13 PM
    Author     : DLK 1
--%>
...
<div id="wh_bg">
    ...
    <div id="top">
      <div class="top1" style="width: 1000px;"></div>
       <div id="menu">
        ...
        <br>
        <form  method="post" action="creg.jsp" style="margin-left: 314px;" >     
         <h1>Add Case Details</h1>
        <strong>Prisoner Id : </strong>&emsp;&nbsp;&nbsp;&nbsp; 
 ...
 while(rs2.next()){
     ...
     %>
        ...
        <br><br/>          
        <strong>Cell No :</strong>&emsp;&emsp;&emsp;&nbsp; <input type="text"  required=""  name="cno" style="width: 200px;" >&emsp;&emsp;<br><br/> 
        <strong>Description:</strong>&emsp;&emsp;<input type="text" name="des" value="" required="" style="width: 200px;" /><br><br>
